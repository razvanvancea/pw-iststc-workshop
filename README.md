# 🎭 Scratch to Smart: Playwright + AI Workshop

## 📋 Overview

Welcome to the **Scratch to Smart** workshop! This comprehensive guide will help you set up your environment before the workshop begins.
...
```bash
git clone https://github.com/razvanvancea/pw-iststc-workshop
